...
from train_0530 import fit_transform
...
if __name__=="__main__":
    ...
    # train
    # relationship_file_train = '../Data/train_data_splitClusters.txt'
    # node_feature_file_train = '../Data/UKB_node_feature_gpt_train_splitClusters.npy'
    relationship_file_train = '../Data/train_data_splitClusters_0530.txt'
    node_feature_file_train = '../Data/UKB_node_feature_gpt_train_splitClusters_0530.npy'
    ...
    # validate
    relationship_file_val = '../Data/val_data_splitClusters_0530.txt'
    node_feature_file_val = '../Data/UKB_node_feature_gpt_val_splitClusters_0530.npy'
    ...
    embedData(modelPath = './UKB_best_dgi_0530.pkl', 
              features = features, 
              adj = adj, 
