...
if __name__=="__main__":
    ...
    # train
    relationship_file_train = '../Data/train_data_splitClusters_add_filtered_disGeNet_disease_disease_PPI_proteinTopEid_metaboliteTopEid.txt'
    node_feature_file_train = '../Data/UKB_node_feature_gpt_train_splitClusters_add_filtered_disGeNet_disease_disease_PPI_proteinTopEid_metaboliteTopEid.npy'
    ...
    # validate
    relationship_file_val = '../Data/val_data_splitClusters_add_filtered_disGeNet_disease_disease_PPI_proteinTopEid_metaboliteTopEid.txt'
    node_feature_file_val = '../Data/UKB_node_feature_gpt_val_splitClusters_add_filtered_disGeNet_disease_disease_PPI_proteinTopEid_metaboliteTopEid.npy'
    ...
    fit_transform(features=features_train, 
                  ...
                  num_neighbors=[-1, 100],  
                  batch_size=100, 
                  tmp_path='UKB_best_dgi_all_GAT_add_filtered_disGeNet_disease_disease_PPI_proteinTopEid_metaboliteTopEid.pkl')    

    # embed all data
    relationship_file = '../Data/merged_df_add_filtered_disGeNet_disease_disease_PPI_proteinTopEid_metaboliteTopEid.txt'
    node_feature_file = '../Data/UKB_node_feature_gpt_add_filtered_disGeNet_disease_disease_PPI_proteinTopEid_metaboliteTopEid.npy'
    embedding_save_file = '../Data/UKB_feature_all_GAT_add_filtered_disGeNet_disease_disease_PPI_proteinTopEid_metaboliteTopEid.npy'
