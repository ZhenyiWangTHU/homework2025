...
def fit_transform(features, 
    ...
    ## Cluster-GCN
    cluster_data = ClusterData(data, num_parts=20, recursive=False, save_dir=None)
    ...
    ## Cluster-GCN
    validation_cluster_data = ClusterData(data_validation, num_parts=10, recursive=False, save_dir=None)
    validation_loader = ClusterLoader(validation_cluster_data, batch_size=5, shuffle=False, num_workers=0)
